...
{
    class ProgramCosmosRead_ProvidersOrangeBooster
    {
        ...
        public async Task GetStartedDemoAsync()
        {
            ...
            this.cosmosClient = new CosmosClient(EndpointUri, PrimaryKey, new CosmosClientOptions() { ApplicationName = "ProgramCosmosRead_ProvidersOrangeBooster" });
        ...
        private async Task CreateContainerAsync()
        {
            ...
            this.container = await this.database.CreateContainerIfNotExistsAsync(containerId, "/npi");
        ...
        private async Task QueryItemsAsync()
        {
            ...
            FeedIterator<OrangeBoosterProvider> queryResultSetIterator = this.container.GetItemQueryIterator<OrangeBoosterProvider>(queryDefinition);

            List <OrangeBoosterProvider> providers = new List<OrangeBoosterProvider>();

            while (queryResultSetIterator.HasMoreResults)
            {
                FeedResponse<OrangeBoosterProvider> currentResultSet = await queryResultSetIterator.ReadNextAsync();
                foreach (OrangeBoosterProvider a in currentResultSet)
                {
                    var str = Newtonsoft.Json.JsonConvert.SerializeObject(a);
